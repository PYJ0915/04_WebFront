...
document.querySelector("#btn1").addEventListener("click", () => {
  ...
  // - appendChild : 노드만 추가 가능 (createTextNode()와 같은 노드를 만드는 함수 필수 작성!) / 한 번에 한 개만 추가 가능
